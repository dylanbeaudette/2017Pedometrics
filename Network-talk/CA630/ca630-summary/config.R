...
raster.list <- list(
  continuous=list(
    ...
    `Frost-Free Days`='E:/gis_data/prism/ffd_50_pct_800m.tif',
    ...
    `NLCD Impervious Surface (%)`='E:/gis_data/region-2-mu-analysis/nlcd_impervious_2011_cropped.tif',
